...
local function PGOYP_fake_script() -- OopssGuiBABFT.Start 
...
coroutine.wrap(PGOYP_fake_script)()
local function BEOPA_fake_script() -- Frame.Client 
...
coroutine.wrap(BEOPA_fake_script)()
local function LUNVKCU_fake_script() -- GUI.Normal 
...
coroutine.wrap(LUNVKCU_fake_script)()
local function KRZQ_fake_script() -- GUI.Only gold block 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(KRZQ_fake_script)()
local function HDQJGQ_fake_script() -- GUI.Teleport 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(HDQJGQ_fake_script)()
local function ZBHSUWW_fake_script() -- GUI.Fast 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(ZBHSUWW_fake_script)()
local function DQZM_fake_script() -- GUI.Spammer 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(DQZM_fake_script)()
local function YZNOJMQ_fake_script() -- GUI.Autobuy 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(YZNOJMQ_fake_script)()
local function IXEA_fake_script() -- GUI.Anti AFK 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(IXEA_fake_script)()
local function EBGLZIY_fake_script() -- GUI.Fly 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(EBGLZIY_fake_script)()
