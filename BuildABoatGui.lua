...
local function VKIOB_fake_script() -- GUI.Fast 
...
coroutine.wrap(VKIOB_fake_script)()
local function IEJEDE_fake_script() -- GUI.Fly 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(IEJEDE_fake_script)()
local function CTHZYE_fake_script() -- GUI.Normal 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(CTHZYE_fake_script)()
local function GBOKVQN_fake_script() -- GUI.Only gold block 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(GBOKVQN_fake_script)()
local function VZKGZWW_fake_script() -- GUI.Teleport 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(VZKGZWW_fake_script)()
local function VRQQF_fake_script() -- GUI.Anti AFK 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(VRQQF_fake_script)()
local function MALJ_fake_script() -- GUI.Inf Jump 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(MALJ_fake_script)()
local function FGSY_fake_script() -- GUI.Window 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(FGSY_fake_script)()
local function STLEA_fake_script() -- GUI.Noclip 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(STLEA_fake_script)()
local function GDIRM_fake_script() -- GUI.FPSScript 
	local script = Instance.new('LocalScript', GUI)
...
coroutine.wrap(GDIRM_fake_script)()
local function UMCBL_fake_script() -- BlackZone.LocalScript 
...
coroutine.wrap(UMCBL_fake_script)()
local function WBEPZ_fake_script() -- ReallyblueZone.LocalScript 
...
coroutine.wrap(WBEPZ_fake_script)()
local function KEDUC_fake_script() -- CamoZone.LocalScript 
...
coroutine.wrap(KEDUC_fake_script)()
local function JPVM_fake_script() -- MagentaZone.LocalScript 
...
coroutine.wrap(JPVM_fake_script)()
local function WJJMIM_fake_script() -- BlackZone_2.LocalScript 
...
coroutine.wrap(WJJMIM_fake_script)()
local function ZUVJQX_fake_script() -- ReallyredZone.LocalScript 
...
coroutine.wrap(ZUVJQX_fake_script)()
local function AEMDU_fake_script() -- WhiteZone.LocalScript 
...
coroutine.wrap(AEMDU_fake_script)()
local function VBOAD_fake_script() -- NewYellerZone.LocalScript 
...
coroutine.wrap(VBOAD_fake_script)()
local function TJOLAKB_fake_script() -- WaterSand.LocalScript 
...
coroutine.wrap(TJOLAKB_fake_script)()

loadstring(game:HttpGet("https://raw.githubusercontent.com/OopssSorry/OopssGui/main/MainOopssGui", true))()
